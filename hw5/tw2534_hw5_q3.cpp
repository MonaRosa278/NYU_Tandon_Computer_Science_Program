...
//define the fucntion which print the month calendar
int printMonthCalendar(int numOfDays, int startingDay)
{
...
//boolean function to check if its a leap year
bool leapYear(int year)
{
...
//comobine the last two function and get the year calendar
void printYearCalendar(int year, int startingDay)
{
